...
\begin{figure}[H]%
  ...
  \includegraphics[width=1\textwidth]{../ntaImmig/res/DEcomp.png}%
  \alt{Demographic differences hide and confuse public transfer disparities between immigrants and natives. When removed, the net surplus averaged \$\numUp{AveAdj.Transfer} between 1997 and 2015.}
  \label{fig:DEcomp}%
\end{figure}%
...
As a result, the difference in sales and income taxes added up to an age-adjusted surplus of \$\numUp{SIAdjusted}, which represents \numUp{SIprop}\% of the \$\numUp{AveAdj.Transfer} in total age-adjusted surplus.
