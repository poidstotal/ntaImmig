...
\begin{figure}[H]%
  ...
  \includegraphics[width=1\textwidth]{../ntaImmig/res/aggTrend.png}%
  \alt{Until 2001, immigrants contributed more to public finances than their population share, but the situation reversed from 2002 and worsened from 2012.}
  \label{fig:aggTrend}%
\end{figure}%
...
\begin{figure}[H]%
  ...
  \includegraphics[width=1\textwidth]{../ntaImmig/res/netDiff.png}%
  \alt{Compared to natives, immigrants received more from public finances than they contributed. The per capita net surplus averaged \$\num{1400} between 1997 and 2011, but surged beyond \$\num{2100} in 2013.}
  \label{fig:netDiff}%
\end{figure}%
