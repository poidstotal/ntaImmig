...
On average between 1997 abnd 2015, immigrants contribute for about \$\numUp{AvePmtImmigrantOutflows} per year while receiving about \$\numUp{AvePmtImmigrantInflows}\$ per year in average betwen 1997 and 2015. native on the other hand contributed \$\numUp{AveCanadianBornOutflows} but received \$\numUp{AveCanadianBornInflows}.
